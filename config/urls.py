...
from apps.events.views import EventTypeViewSet, EventViewSet, EventParticipationViewSet, MyEventsView, MyStatsView, my_participation_accept, my_participation_decline, MyParticipationsView, LectureRatingViewSet, TagViewSet, LectureMaterialViewSet, MyLectureApplicantsView
...
urlpatterns = [
    ...
    path('api/v1/my/lectures/<int:pk>/applicants/', MyLectureApplicantsView.as_view(), name='my-lecture-applicants'),
